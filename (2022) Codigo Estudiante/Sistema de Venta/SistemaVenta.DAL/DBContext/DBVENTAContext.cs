...
public partial class DBVENTAContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdCategoria).HasName("PK__Categori__8A3D240CA5B8F285");
        ...
        {
            entity.HasKey(e => e.IdDetalleVenta).HasName("PK__DetalleV__BFE2843F2E1C5A58");
            ...
            entity.HasOne(d => d.IdVentaNavigation).WithMany(p => p.DetalleVenta)
                ...
                .HasConstraintName("FK__DetalleVe__idVen__7C4F7684");
        });

        modelBuilder.Entity<Menu>(entity =>
        {
            entity.HasKey(e => e.IdMenu).HasName("PK__Menu__C26AF4834BCE529C");
        ...
        {
            entity.HasKey(e => e.IdNegocio).HasName("PK__Negocio__70E1E107E440389B");
        ...
        {
            entity.HasKey(e => e.IdNumeroCorrelativo).HasName("PK__NumeroCo__25FB547EE14D19DC");
        ...
        {
            entity.HasKey(e => e.IdProducto).HasName("PK__Producto__07F4A132062D519F");
            ...
            entity.HasOne(d => d.IdCategoriaNavigation).WithMany(p => p.Productos)
                ...
                .HasConstraintName("FK__Producto__idCate__6EF57B66");
        });

        modelBuilder.Entity<Rol>(entity =>
        {
            entity.HasKey(e => e.IdRol).HasName("PK__Rol__3C872F768A188F13");
        ...
        {
            entity.HasKey(e => e.IdRolMenu).HasName("PK__RolMenu__CD2045D813ED0C50");
        ...
        {
            entity.HasKey(e => e.IdTipoDocumentoVenta).HasName("PK__TipoDocu__A9D59AEEC8C004BD");
        ...
        {
            entity.HasKey(e => e.IdUsuario).HasName("PK__Usuario__645723A6BA6E92F8");
        ...
        {
            entity.HasKey(e => e.IdVenta).HasName("PK__Venta__077D5614D59EF47A");
            ...
            entity.HasOne(d => d.IdTipoDocumentoVentaNavigation).WithMany(p => p.Venta)
                ...
                .HasConstraintName("FK__Venta__idTipoDoc__778AC167");

            entity.HasOne(d => d.IdUsuarioNavigation).WithMany(p => p.Venta)
                .HasForeignKey(d => d.IdUsuario)
                .HasConstraintName("FK__Venta__idUsuario__787EE5A0");
        });
